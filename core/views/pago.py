...
from ..models import Reserva, InscripcionCurso, PedidoProducto, MetodoPago, BitacoraPago
...
def bitacora_pagos(request):
    pagos = BitacoraPago.objects.all().order_by('-fecha_pago')
    return render(request, 'core/bitacora_pagos.html', {'pagos': pagos})